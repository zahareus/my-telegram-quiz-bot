...
from src.domain.service import MessageService, UserService
import logging
...
async def get_info():
    async with sessionmanager.session() as session:
        ...
        user_ids: List[str] = await user_service.get_admins_ids()
        for user_id in user_ids:
            await bot.send_message(user_id, summary_result)
